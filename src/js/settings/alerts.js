...
CM.settings.alerts = (function() {
    ...
    this.title = 'Timers & Alerts';
    this.desc  = '<strong>Notice:</strong>If you want to use custom audio alerts; please be mindful to link to non-copyrighted audio files on sites that explicitly allow hotlinking to avoid http://orteil.dashnet.org getting blacklisted!<br />Links to soundjay.com files are blocked as per the main game code.';
    this.items = {
